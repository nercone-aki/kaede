...
class TestRequestLine:
    ...
    def test_fragment_in_target_current_behavior(self):
        """Current parser behavior: fragment identifiers are not rejected in request target."""
        req = H1.parse_request(
            b"GET /path?q=1#frag HTTP/1.1\r\nHost: example.com\r\n\r\n",
            client=CLIENT,
        )
